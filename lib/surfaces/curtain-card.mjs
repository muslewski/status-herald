...
export const renderCard = (
  ...
  if (denizensOn && theatrics.entity) {
    ...
    if (tier !== "none") {
      ...
      if (cel.length) {
        // Center on ink silhouette (asymmetric pad in authored cels used to
        // leave the cat left of the anvil/label axis).
        const placed = placeDenizen(cel, cols, rows);
        denizenZone = { top: placed.top, left: placed.left };
        denizen = placed.cel;
      }
    }
  }
