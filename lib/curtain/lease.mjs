...
/**
 * Re-arm non-expired leases. Expired leases are NOT resurrected.
 * When `kinds` is a non-empty array, only those kinds are re-armed;
 * other live leases pass through with the same exp.
 * @param {Lease[]} leases
 * @param {number} nowSec
 * @param {object} [cfg]
