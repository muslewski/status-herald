...
// block off-center) and trailing space, then RIGHT-PAD every line to the block
// width before centering. Without that pad, author padding like "   ✓   " or
// " .---. " loses its trailing spaces and the head/anvil no longer share a
// center axis — the glitch operators see as "coordinates off / animation
// glitched". The frame still moves as one unit; internal shape is preserved.
