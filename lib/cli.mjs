    ...
    switch (sub) {
      ...
      default:
        process.stderr.write(
          "usage: herald curtain <up|down|arm|disarm|cover|reveal|reveal-all|pause|resume|pause-all|resume-all|pet|focus|arm-all|refresh|hook|event|status|install|uninstall|doctor|inspect|after-kill-window>\n" +
