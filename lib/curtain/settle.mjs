...
// No lease kind is exempt — watchers hold only while live; TTL is the RC2 bound.
...
export const settleIfStale = (snap, nowSec, cfg = {}) => {
  ...
  // 6. No watcher-immunity branch — live watcher is just a non-zero count
  //    holding rule 4 off until the lease expires (RC2).
