  ...
  forge: {
    ...
    states: {
      ...
      compacting: {
        ...
        fg: "brightGreen",
        label: "DONE",
        // Same 5×7 grid as working: sparks cool on the finished billet, then
        // the piece resolves into a large ASCII check (no thin emoji).
        // ASCII-only forge palette (# = * | + - . / \\ V space) — no middle-dot
        // · (ambiguous cell width, shifts the anvil divider on some terminals).
        // Check strokes share the anvil center (top / at col 4, not col 5).
        frames: [
          [" * . * ", " |###| ", " '-+-' ", "   |   ", "======="],
          ["  . .  ", " |###| ", " '-+-' ", "   |   ", "======="],
          ["       ", " |###| ", " '-+-' ", "   |   ", "======="],
      ...
      needs: {
        fg: "brightRed",
        label: "NEEDS YOU",
        // Soft pulse at working resolution (no hard strobe).
        frames: [
          ["  /!\\  ", "  ! !  ", "   |   ", "       ", "======="],
          [" / ! \\ ", " !   ! ", "   |   ", "       ", "======="],
          ["  /!\\  ", "  ! !  ", "   |   ", "       ", "======="],
